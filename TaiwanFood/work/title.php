...
if($_SESSION['username'] != null)
{
    ...
    { 
        echo "<div style=\"float:right; text-align:right\">".$row[name];
        echo "  <a href=\"DataManage.php\">資料管理</a>";
        echo "  <a href=\"logout.php\">登出</a></div>";
    }
}
else
{
          echo "<div style=\"float:right; text-align:right\"><a href=\"Login.html\" >登入</a></div>";
}
