  ...
  ?>
	...
	<script>
      ...
      <?php
          ...
          ?>
      <title>美食地圖-高雄<?php echo $reg; ?></title>
      <script>
      function getStart()
      {
      <?php
...
<body style="background:rgb(190,190,190);margin:0px" onload="getRegion();getStart();Marked();BestPath();">
	<div id="wrap">
		<div id="Btop">
          ...
          ?>
          <td style="width:25%"><span class="Ttext" >現在位置: </span><a class="nowP" href="index.html">台灣</a><span class="Ttext">&nbsp;>&nbsp;</span><a class="nowP" href="l.html">高雄市</a><span class="Ttext">&nbsp;>&nbsp;</span><a class="nowP" href="#"><?php echo $reg; ?></a></td>
  ...
  <table border="0" style="width:auto;margin-left:auto;margin-right:auto;">
  <tr><th>
	<div style="height:94.6%">
		<div id="Main_" >
			...
			<div id="user_">
				<div id="where_">
					<form action="qqq.php?region=<?php echo $region;?>" method="post">
				...
				<div id="result_">
    				...
    				<tr><td><h2>所選清單：</h2></td></tr> 
      				...
      				for (i=0; i<cnt; i=i+1)
      				{
          				...
          				if((count%2) == 1)
          				{
              				document.write("<tr><td id=\"one\"><a href=\""+link[i]+"\" target=\"_blank\" style=\"color:black;\">"+count+". "+fn[i] + "</a></td></tr>");
          				}
         				else
          				{
              				document.write("<tr><td id=\"two\"><a href=\""+link[i]+"\" target=\"_blank\" style=\"color:black;\">"+count+". "+fn[i] + "</a></td></tr>");
          				}
      				}
   					</script>
  					</table>
